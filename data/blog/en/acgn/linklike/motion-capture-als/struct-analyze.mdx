...
This article uses [tools written by the author](https://github.com/ChocoLZS/linkura-cli/releases/tag/linkura-motion-cli-v1.1.0) for analysis. It's essentially a summary of the packet structure rather than a reverse engineering replay.
