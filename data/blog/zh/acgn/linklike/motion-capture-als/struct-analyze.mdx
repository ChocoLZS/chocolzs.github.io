...
lastmod: '2025-08-17'
language: zh
tags: ['逆向', 'linkura', 'Link!Like!', 'lovelive', 'protobuf', '手游', '二次元', 'ACGN', 'reverse', 'link like lovelive reverse']
authors: ['choco']
draft: false
wip: false
featured: true
...
本文使用了[笔者编写的工具](https://github.com/ChocoLZS/linkura-cli/releases/tag/linkura-motion-cli-v1.1.0)进行分析，其实算是对数据包结构的总结，而不是逆向分析的复盘。
...
直播数据是通过[笔者编写的工具](https://github.com/ChocoLZS/linkura-cli/releases/tag/linkura-motion-cli-v1.1.0)获取的
