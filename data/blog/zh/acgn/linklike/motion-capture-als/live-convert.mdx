...
lastmod: '2025-08-09'
language: zh
tags: ['逆向', 'linkura', 'Link!Like!', 'lovelive', 'protobuf', 'reverse', 'link like lovelive reverse']
authors: ['choco']
...
> 转换工具实现：[地址](https://github.com/ChocoLZS/linkura-cli/releases/tag/linkura-motion-cli-v1.1.0)
...
<div className='w-full pt-[56.25%] relative'>
  <iframe className='absolute inset-0 w-full h-full' src="//player.bilibili.com/player.html?isOutside=true&aid=114997430652272&bvid=BV1hBt4zJEaB&cid=31583045570&p=1" scrolling="no" border="0" frameBorder="no" framespacing="0" allowFullScreen={true}></iframe>
</div>